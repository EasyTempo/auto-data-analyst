...
user_goal = st.text_input("What is your analysis goal? (e.g. 'Clean the data and show me a summary of sales')")
...
if st.button("Run Analysis"):
    if uploaded_file is not None and user_goal:
        try:
            ...
            final_conclusion = ""
            for step_name, content in analyst.process_data(df, user_goal):
